...
const adminVehicleGrid =
    document.getElementById("adminVehicleGrid");
...
const editPhotoGrid =
    document.getElementById("editPhotoGrid");

const noPhotosMessage =
    document.getElementById("noPhotosMessage");
        ...
        async (event) => {
            ...
            try {
                ...
                for (
                    ...
                    const nomeArquivo =
                        `${veiculo.id}/${Date.now()}-${i}.${extensao}`;
                    ...
                    if (erroUpload) {
                        ...
                        throw new Error(
                            `Erro ao enviar foto ${i + 1}: ${erroUpload.message}`
                        );
                    }
                    ...
                    if (erroFoto) {
                        ...
                        throw new Error(
                            `Erro ao salvar foto ${i + 1}: ${erroFoto.message}`
                        );
                    }
...
function criarCardAdmin(
    ...
    card.innerHTML = `
        ...
        <div class="admin-card-image">
            ...
            <span
                class="admin-card-status ${statusClasse}"
            >
            ...
            ${veiculo.destaque
            ? `
                        <span class="admin-card-featured">
                            ★ DESTAQUE
                        </span>
                    `
            : ""
        ...
        <div class="admin-card-body">
            ...
            <div class="admin-card-actions">
                ...
                <button
                    type="button"
                    class="card-button delete delete-button"
                    data-id="${veiculo.id}"
                >
                    Excluir
                </button>
...
function renderizarFotosEditor() {
    ...
    if (
        !fotosEditando ||
        fotosEditando.length === 0
    ) {

        noPhotosMessage.style.display =
            "block";
    ...
    try {
        ...
        if (caminho) {
            ...
            if (erroStorage) {
                ...
                console.warn(
                    "Erro ao apagar arquivo do Storage:",
                    erroStorage
                );
        ...
        async () => {
            ...
            try {
                ...
                for (
                    ...
                    const nomeArquivo =
                        `${id}/${Date.now()}-${Math.random().toString(36).slice(2)}.${extensao}`;
        ...
        if (
            ...
            if (
                ...
                if (erroStorage) {
                    ...
                    console.warn(
                        "Erro ao remover fotos do Storage:",
                        erroStorage
                    );
